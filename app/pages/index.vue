        ...
        <main>
          <div class="mainicon">
            <div class="recipes">
                  ...
                  <!-- <a id="recipebutton" href="recipe_overview.html?filterrecipe=allerezepte">Rezepte</a> -->
            </div>
            <div class="vl"></div>
            <div class="hl"></div>
            <div class="photography">
                ...
                <!-- <NuxtLink to="/gallery" aria-hidden="true"><img src="assets/images/Icon_Fotografie.PNG" alt="Kameraumriss"></NuxtLink> -->
                <NuxtLink :to="{ path: '/gallery', query: { filter: 'allebilder' } }" data-filter="allebilder" id="photographybutton">Fotografie</NuxtLink>
                <!-- <a id="photographybutton" href="galerie.html?filter=allebilder">Fotografie</a> -->
            </div>
          </div>
